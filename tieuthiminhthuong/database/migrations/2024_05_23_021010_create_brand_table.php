...
return new class extends Migration
{
    ...
    {
        Schema::create('ttmt_brand', function (Blueprint $table) {
            ...
            $table->integer('sort_order')->unsigned()->default(0); // sort_order: int, UNSIGNED, Default 0
    ...
    {
        Schema::dropIfExists('ttmt_brand');
    }
};
